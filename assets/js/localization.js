const translations = {
    "ru": {
        ...
        "feature_5_title": "Легальность",
        "feature_5_desc": "Бот использует только официально разрешённые механизмы доступа, что исключает риск блокировок.",
    ...
    "ua": {
        ...
        "feature_5_title": "Легальність",
        "feature_5_desc": "Бот використовує лише офіційно дозволені механізми доступу, що виключає ризик блокувань.",
    ...
    "en": {
        ...
        "cta_btn": "Get Bot",
        "feature_5_title": "Legality",
        "feature_5_desc": "The bot uses only officially allowed access mechanisms, which eliminates the risk of bans.",
